...
public class MetaGraphCreationDepreciated {
    ...
    private void constructMetaGraph(Graph inputG, String s, String t, double desiredFlow) {
        ...
        flow = desiredFlow;
        targetID = t;
        explored = new Stack<MetaNodeDepreciated>();
        ...
        meta.addMetaNode(new MetaNodeDepreciated(startNodeName, startState));
...
//        }
    ...
    private void populateMetaGraph() {
        ...
        while (!explored.empty()) {
            MetaNodeDepreciated current = explored.pop();
...
//                System.out.println("Finding new meta nbr for: " + current.getState().toString());
     ...
     */
    private int iterativeFindMetaNbrs(MetaNodeDepreciated current) {
        int nbrCount = 0;
...
//        System.out.println("Complete states: " + completeStates);
        ...
        for (HashMap<String, Double> state : completeStates) {
            MetaNodeDepreciated metaNode = new MetaNodeDepreciated(state.toString(), state);
